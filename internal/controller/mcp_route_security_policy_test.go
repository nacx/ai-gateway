...
func TestMCPRouteControllerCleanupSecurityPolicyResources(t *testing.T) {
	// Virtualize time so the exponential backoff in the sync loop doesn't slow down the test.
	synctest.Test(t, testMCPRouteControllerCleanupSecurityPolicyResources)
}
